		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Control Personalizado SAPUI5",
									"targetURL": "#mynamespacecustomcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mynamespacecustomcontrol-display": {
								"semanticObject": "mynamespacecustomcontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mynamespace.customcontrol",
									"url": sap.ui.require.toUrl("mynamespace/customcontrol")
								}
							}
						}
					}
